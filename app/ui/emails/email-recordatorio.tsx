  ...
  return (
    <EmailWrapper preheader="Tienes un curso pendiente, [Nombre]. ¡Ya casi terminas!">
      ...
      <p className="text-[#333333]/65 text-sm leading-relaxed mb-6">
        Dejaste el curso{" "}
        <strong className="text-[#1c2634]">[Nombre del Curso]</strong> a medias.
        Solo te quedan <strong className="text-[#1c2634]">[N] módulos</strong>{" "}
      ...
      <p className="text-[#333333]/40 text-xs leading-relaxed text-center">
        Te enviamos este recordatorio porque tienes un curso activo. Si ya lo
        terminaste, ignora este mensaje.
      </p>
    </EmailWrapper>
  );
}
